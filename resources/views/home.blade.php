...
<body class="index-page">
    ...
    <a href="#" class="btn-cta">
        <button id="donateButton" class="btn m-4 mt-4 text-white"
            ...
            data-bs-toggle="modal" data-bs-target="#countryDonateModal">
            Donate
        </button>
    </a>
    <a href="#" class="btn-cta">
        <button id="sponsorButton" class="btn m-4 mt-4"
            ...
            data-bs-toggle="modal" data-bs-target="#countrySponsorModal">
            Sponsor
        </button>
    </a>
</div>
            ...
            <div class="container">
                <div class="row gy-4 justify-content-between align-items-center">
                    ...
                    <div class="col-lg-5 order-lg-1" data-aos="fade-up" >
                        <h2 class="content-title mb-4" style="color: #0a4e77">Rescue. Nurture. Empower
                        </h2>
                        <p class="mb-4">
                        ...
                        <p class="mt-4" style="font-weight: bold !important; margin-top: 3rem !important; border-radius: 16px;" ><a href="https://sponsorship.fopinternational.org/donate" style="font-size: 12px !important; font-weight: bold !important; margin-top: 5rem !important;" class="btn-cta "
                ...
                <div class="row gy-4 justify-content-between align-items-center h-100">
                    ...
                    <div class="col-lg-5 order-lg-1" data-aos="fade-up" >
                        ...
                        <ul class="list-unstyled">
                         ...
                         <p class="mt-4" style=" !important; font-weight: bold !important; margin-top: 3rem !important; padding: -1rem !important; border-radius: 16px;" ><a href="https://sponsorship.fopinternational.org/" style="font-size: 12px !important; font-weight: bold !important; margin-top: 5rem !important;" class="btn-cta "
                        ...
                        <script type="application/json" class="swiper-config">
  {
    ...
    "breakpoints": {
      ...
      "1200": {
       ...
       <!-- Modal Structure -->
       <div class="modal fade" id="countryDonateModal" tabindex="-1" aria-labelledby="countryModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="donateForm">
                    <label for="countryDonateSelect" class="form-label">Country</label>
                    <select id="countryDonateSelect" class="form-control" style="width: 100%;">
...
<!-- Modal for Sponsor -->
<div class="modal fade" id="countrySponsorModal" tabindex="-1" aria-labelledby="countryModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Select Your Country</h5>
            ...
            <div class="modal-body">
                <form id="sponsorForm">
                    <label for="countrySponsorSelect" class="form-label">Country</label>
                    <select id="countrySponsorSelect" class="form-control" style="width: 100%;">
                        <option value="gb" data-flag="gb">United Kingdom</option>
                        <option value="ug" data-flag="ug">Uganda</option>
                        <option value="nz" data-flag="nz">New Zealand</option>
                        <option value="other">Other</option>
...
$(document).ready(function() {
    ...
    function initCountrySelect(selectId) {
        $(selectId).select2({
    ...
    function formatCountry(state) {
        ...
        if (flag) {
            const flagUrl = `https://cdnjs.cloudflare.com/ajax/libs/flag-icon-css/3.4.3/flags/4x3/${flag}.svg`;
            return $(`<span><img src="${flagUrl}" class="img-flag" style="width: 20px; height: auto;"/> ${state.text}</span>`);
        }
        return state.text;
    }

    // Initialize Select2 for both dropdowns
    initCountrySelect('#countryDonateSelect');
    initCountrySelect('#countrySponsorSelect');
